  ...
  <div>
    <footer>
      <div class="footer">
        <div class="container">
          <div class="content">
            <div class="footer-item item-name">
              <h1>慶宇汽車 保養修理廠</h1>
              <div class="pic">
                <img :src="factory" alt="factory">
              </div>
            </div>
            <div class="footer-item item-contact">
              <h1>聯絡方式</h1>
              <nav>
            ...
            <div class="footer-item item-icon">
              <ul class="navbar-nav">
                ...
                <li>
                  <a href="https://line.me/ti/p/W0F_TIdcaD"><i class="fab fa-line"></i></a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="copyright">
        Copyright &copy; 2020 慶宇汽車 保養修理廠
      </div>
    </footer>
  </div>
</template>
